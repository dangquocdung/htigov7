                        ...
                        <article>
                            <div class="post-image">
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="news_info">
                                        <p><i><span>Đăng ngày:&nbsp;</span>{{ Carbon\Carbon::parse($Topic->date)->format('d-m-Y').' '.Carbon\Carbon::parse($Topic->date)->format('H:i') }}</i></p>
                                    </div>
                            ...
                            @if( $Topic->webmasterSection->customFields->count() > 0 )
                                <br>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="col-lg-12">
